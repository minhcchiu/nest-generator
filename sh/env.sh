...
export JWT_EXPIRATION="1*60"
export JWT_ACCESS_EXPIRATION="1*60"
export JWT_REFRESH_EXPIRATION="3*60"
export JWT_RESET_PASSWORD_EXPIRATION="1*60"
export JWT_SIGNUP_EXPIRATION="1*60"
