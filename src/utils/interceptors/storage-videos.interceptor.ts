...
export const StorageVideosInterceptor = (
  fieldName: string,
  ...
  class Interceptor implements NestInterceptor {
    ...
    private getMulterOptions() {
      ...
      const fileSize = Math.pow(1024, uploadConfig.maxVideoSize);
      const extAllowed = uploadConfig.extVideo;
