...
export class AccountController {
  ...
  async create(@GetCurrentUserId() userId: ObjectId, @Body() body: CreateAccountDto) {
    body.userId = userId;
  ...
  @Patch("/:id")
  @HttpCode(HttpStatus.OK)
  async update(@Param("id", ParseObjectIdPipe) id: ObjectId, @Body() body: UpdateAccountDto) {
